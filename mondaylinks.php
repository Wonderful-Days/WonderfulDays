...
<html lang="en">
  ...
  <div class="container">
    <h2 class="text-center">See the recodings of our Wonderful-Days</h2>
  </div>
...
<div class="row">
    ...
    <div class="col-6">
        <div class="card" style="width: 28rem;">
            <div class="card-body">
              <h5 class="card-title">Join our previous events of Mooney Monday</h5>
            </div>
            <table class="table">
                <thead>
                  <tr>
...
<div class="col-6">
    <div class="card" style="width: 28rem;">
        <div class="card-body">
          <h5 class="card-title">Join our previous events of Motivational Monday</h5>
        </div>
        <table class="table">
            <thead>
              <tr>
