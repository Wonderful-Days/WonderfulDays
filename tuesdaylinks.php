...
<html lang="en">
  ...
  <div class="container">
    <h2 class="text-center">See the recodings Tuesday Section</h2>
  </div>
    ...
    <div class="row text-center">
        <div class="col-12">       
                <div class="card" style="width: 28rem;">
                    <div class="card-body">
                      <h5 class="card-title">Join our previous events of Tuesday</h5>
                    </div>
                    <table class="table">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          <tr>
                             <th scope="row">1</th>
                            <td>Dec 27, 2022</td>
                            <td>Teacher Tuesdays is a networking event designed to foster peer-to-peer support for learning.</td>
                            <td><a href="https://www.youtube.com/watch?v=oSafTADE8iU">Click Here</a></td>
                          </tr>
                        </tbody>
                        <tbody>
                            <tr>
                              <th scope="row">2</th>
                              <td>jan 3,23</td>
                              <td> Building a learning community around Science, Technology, Engineering, Arts and Math (STEAM)Education for our region.</td>
                              <td><a href="https://youtu.be/NiuRvJj8foA">Click Here</a></td>
                            </tr>
                          </tbody>
                          <tbody>
                            <tr>
                              <th scope="row">3</th>
                              <td>jan 10,23</td>
                              <td>Engage the students and faculty in innovation and start up activities in campus </td>
                              <td><a href="https://youtu.be/rxpGwFj9i90">Click Here</a></td>
                            </tr>
                          </tbody>
                          <tbody>
                            <tr>
                              <th scope="row">4</th>
                              <td>Jan 17,23</td>
                              <td>Framework for implementation of National Education Policy-2020 </td>
                              <td><a href="https://youtu.be/rMqKBAXC0xA">Click Here</a></td>
                            </tr>
                          </tbody> 
                          <tbody>
                            <tr>
                          ...
                          <tbody>
                            <tr>
                              <th scope="row">6</th>
                              <td>jan 31,23</td>
                              <td>Build, streamline and strengthen the innovation and entrepreneurial ecosystem in campus</td>
                              <td><a href="https://drive.google.com/drive/folders/13zoYJgYcSCFAzlzLIoyJHEtkNzhHchFn">Click Here</a></td>
                            </tr>
                          </tbody>
                          <tbody>
                            <tr>
                              <th scope="row">7</th>
                              <td>feb 7,23</td>
                              <td>Genetics VS. Environment</td>
                              <td><a href="https://drive.google.com/drive/folders/1AiV4J4857pjZcNvcWLzRh6eaKndENxHt">Click Here</a></td>
                            </tr>
                          </tbody>
                          <tbody>
                            <tr>
                              <th scope="row">8</th>
                              <td>feb 14,23</td>
                              <td>Establish a club where no dicceimination is encouraged and provision student platform to show case there talent.</td>
                              <td><a href="https://drive.google.com/drive/folders/1O2o-SDNcgNu1DdAh5ri4uOXsGRyzw2fx">Click Here</a></td>
                            </tr>
                          </tbody>
                    </table>
                  </div>
