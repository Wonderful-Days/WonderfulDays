...
<html lang="en">
  ...
  <div class="container">
    <h2 class="text-center">See the recodings of Wednesday Event</h2>
  </div>
...
<div class="row">
    ...
    <div class="col-6">
        <div class="card" style="width: 28rem;">
            <div class="card-body">
              <h5 class="card-title">Join our previous events of Wonderful Wednesday</h5>
            </div>
            <table class="table">
                <thead>
                  <tr>
...
<div class="col-6">
    <div class="card" style="width: 28rem;">
        <div class="card-body">
          <h5 class="card-title">Join our previous events of Womens Wednesday</h5>
        </div>
        <table class="table">
            <thead>
              <tr>
