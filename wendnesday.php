        ...
        <div class="carousel-item active">
          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-md-6 text-img">
                <img class="img-fluid p-3 img-responsive img" src="images/Copy of WonderfulWednesday.png" alt="" />
              </div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-md-6 text-img">
                <img class="img-fluid p-3 img-responsive img" src="images/WomensWednesday.jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-3 text-center p-5">
          ...
          <p>
            This events provide a platform forindustryleaders,entrepreneurs, investors, and other...<br> <a href="friday.php"><b>Read more...</b></a>
          </p>
        </div>
        <div class="col-md-3 text-center p-5">
