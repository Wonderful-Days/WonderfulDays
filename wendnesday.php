          ...
          <div class="row">
            <div class="col-12">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Wednesday Events</li>
              </ol>
            </div>
          </div>
        </div>
              ...
              <div class="row align-items-center">
                <div class="col-md-6 text-img">
                  <h2 class="animate-charcter">
                    "DISCOVER YOUR PASSIONS AND DREAMS ON WONDERFUL WEDNESDAY. JOIN THE COMMUNITY OF GO-GETTERS AND DREAMERS."
                  </h2>
                  <div class="btn-c">
                    <button class="btn">
                ...
                <div class="col-md-6 text-img">
                  <img
                    ...
                    src="images/Copy of WonderfulWednesday.png"
                    alt=""
                  />
                </div>
              </div>
          ...
          <div class="carousel-item">
            ...
            <div class="container">
              <div class="row align-items-center">
                <div class="col-md-6 text-img">
                  <h2 class="animate-charcter">
                    "Empowering Women to Lead, Inspire and Succeed. Empowering Women Everywhere!"
                  </h2>
                  <div class="btn-c">
                    <button class="btn">
                ...
                <div class="col-md-6 text-img">
                  <img
                    class="img-fluid p-3 img-responsive img"
                    src="images/WomensWednesday.jpg"
                    alt=""
                  />
                </div>
              </div>
...
<h2 class="heading"><div class="waviy">
    ...
    <article class="blog-post">
      <div class="blog-post__img">
        <img src="images/Copy of WonderfulWednesday.png"   alt="" />
      </div>
      <div class="blog-post__info">
        
        <h2 class="blog-post__title">Wonderful Wednesday</h2>
        <p>
          Wonderful Wednesday is a day dedicated to personal growth and goal-setting. On this day, individuals are encouraged to reflect on their passions, interests, and dreams, and to set achievable goals for themselves.

          The focus of Wonderful Wednesday is on helping people to take action towards their aspirations and to live a more fulfilling life. Whether you have a specific goal in mind or just a general idea of what you want to achieve, Wonderful Wednesday provides a platform for you to share your aspirations and receive support and encouragement from others.
            </p>
        <a href="register.php" class="blog-post__cta">Register for Event</a>
        <a href="webnesdaylinks.php" class="blog-post__cta">See Prevoius Events</a>
      </div>
    </article>
...
<h2 id="Womens_Wed"></h2>
    <article class="blog-post second">
      <div class="blog-post__img">
        <img src="images/WomensWednesday.jpg" alt="" />
      </div>
      <div class="blog-post__info">
        
        <h2 class="blog-post__title">Women's Wednesday</h2>
        <p>
          Women's Wednesday is a day to celebrate, honor, and recognize the contributions and achievements of women. It is an opportunity to acknowledge the challenges that women face, honor the women who have made significant contributions to society, recognize progress in the fight for gender equality, and empower and support women. By recognizing the contributions of women in various areas, we can inspire future generations of women to achieve great things.
        </p>
        <a href="register.php" class="blog-post__cta"> Register for Event</a>
       <a href="webnesdaylinks.php" class="blog-post__cta">See Prevoius Events</a>
      </div>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner " style="padding-top: 70px;">
    <div class="carousel-item active text-center">
      ...
      <p style="max-height: 180px;">Kamala Institute of Technology and Science</p>
     
    </div>
    <div class="carousel-item text-center">
      <img src="images/imagePlaceholder.jpg" style="border-radius: 100px;" width="20%" height="200px" class="bd-placeholder-img " alt="">
      <h2 style="padding-top: 20px;">Bala Krishnan</h2>
      <p style="max-height: 180px;">K S R INSTITUTE FOR ENGINEERING AND TECHNOLOGY </p>
      
    </div>
    <div class="carousel-item text-center">
      <img src="images/imagePlaceholder.jpg" style="border-radius: 100px;" width="20%" height="200px" class="bd-placeholder-img " alt="">
      <h2 style="padding-top: 20px;">Padma Raj</h2>
      <p style="max-height: 180px;">Women's Polytechnic College, Puducherry</p>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-3 text-center p-5">
        ...
        <p>
          This events provide a platform forindustryleaders,entrepreneurs, investors, and other...<br> <a
            href="friday.php"><b>Read more...</b></a>
        </p>
      </div>
      <div class="col-md-3 text-center p-5">
