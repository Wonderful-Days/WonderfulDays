      ...
      <div class="row">
        <div class="col-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Saturday Events</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="container ">
      <div class="row align-items-center ">
        <div class="col-md-6 text-img">
          ...
          <h2 class="animate-charcter">"Building the Next Big Thing, Together. Join the Startup Revolution, Every Saturday"
        </h2>
        <div class="btn-c">
        ...
        <div class="col-md-6 text-img">
          <img class="img-fluid p-3 img-responsive img" src="images/saturday.jpg" alt="">
        </div>
      </div>
    </div>
  </section>
...
<section class="content">
  ...
  <h3 class="text-center text"> Startup Saturday</h3>
 <div class="para">
  <p> Startup Saturday is a day dedicated to fostering innovation and entrepreneurship by bringing together individuals with business ideas and providing them with professional support to help bring their ideas to life. On this day, young minds are encouraged to share their business ideas and receive feedback, guidance, and mentorship from experienced professionals.
  </p>
  <p>This day provides an opportunity for individuals to network and connect with others who share their interests and passions. It is a platform for individuals to share their vision, receive constructive criticism, and learn from the experiences of others. Whether you are just starting out or already have a well-established business, Startup Saturday provides an environment for growth and development.
  </p>   
  <p>The goal of Startup Saturday is to support and encourage innovation, entrepreneurship, and the creation of new businesses. By providing a platform for individuals to connect, learn, and grow, Startup Saturday helps to foster a thriving and dynamic entrepreneurial ecosystem. So, if you have a business idea or a passion for entrepreneurship, be sure to participate in Startup Saturday and take advantage of the opportunity to connect with like-minded individuals and learn from experienced professionals.
  </p>
 </div>
 <div class="btn-c">
  <button class="btn "><a href="register.php">Register for Event</a></button>
  <button class="btn"><a href="saturdaylinks.php" class="blog-post__cta">See Prevoius Events</a></button>
</div>
</section>
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner " style="padding-top: 70px;">
      <div class="carousel-item active text-center">
        <img src="images/imagePlaceholder.jpg" style="border-radius: 100px;" width="20%" height="200px"
          class="bd-placeholder-img " alt="">
        <h2 style="padding-top: 20px;">kumar Das</h2>
        <p style="max-height: 180px;">Amrita College of Engineering and Technology, Nagercoil, Tamilnadu.
        </p>
      ...
      <div class="carousel-item text-center">
        <img src="images/imagePlaceholder.jpg" style="border-radius: 100px;" width="20%" height="200px"
          class="bd-placeholder-img " alt="">
        <h2 style="padding-top: 20px;">Manjul Vaihya</h2>
        <p style="max-height: 180px;">PML SD BUSINESS SCHOOL</p>

      </div>
      <div class="carousel-item text-center">
        <img src="images/imagePlaceholder.jpg" style="border-radius: 100px;" width="20%" height="200px"
          class="bd-placeholder-img " alt="">
        <h2 style="padding-top: 20px;">Udhaya Chandran
</h2>
        <p style="max-height: 180px;">"Government Polytechnic College
 Vechoochira"</p>
      </div>
    </div>
