        ...
        <div class="carousel-item active">
          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-md-6 text-img">
                <img class="img-fluid p-3 img-responsive img" src="images/Teaming Thursday.jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-md-6 text-img">
                <img class="img-fluid p-3 img-responsive img" src="images/thirsty Thursday .jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-md-6 text-img">
                <img class="img-fluid p-3 img-responsive img" src="images/throwbackthurshday.jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
